...
class WPSCrack:
    ...
    def run(self):
        ...
        association_request = RadioTap() / Dot11(proto=0, FCfield=0, subtype=0, addr2=self.client_mac,
            ...
            / b"\x2d\x1a\x20\x00\x1a\x3f\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x00" \
              b"\x00\x00\x00\x00\x00\xdd\x1e\x00\x90\x4c\x33\x20\x00\x1a\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
              b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xdd\x07\x00\x50\xf2\x02\x00\x01\x00"
